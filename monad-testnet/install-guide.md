# Monad Testnet Node Ops entry point
...
| Public POSTHUMAN RPC | `https://rpc-monad-testnet.posthuman.digital` |
...
Testnet is not permission to move, copy, expose or dual-run a validator identity.
