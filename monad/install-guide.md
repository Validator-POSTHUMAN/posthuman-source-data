...
> ⚠️ Some upgrades (like `v0.13.0 MONAD_NINE` hard fork) require a **hard reset**. Always check the specific [upgrade instructions](https://docs.monad.xyz/node-ops/upgrade-instructions) before upgrading.

### Stay Updated

- Join the [Monad Developer Discord](https://discord.gg/monad) → `#mainnet-fullnode-announcements` channel
...
| Validator Delegation Program | [docs.monad.xyz/node-ops/validator-delegation-program](https://docs.monad.xyz/node-ops/validator-delegation-program/index) |
| VDP Policy on MEV | [docs.monad.xyz/node-ops/validator-delegation-program/mev](https://docs.monad.xyz/node-ops/validator-delegation-program/mev) |
