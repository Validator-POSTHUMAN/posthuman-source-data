...
The pipeline keeps the snapshot pruned and ready for rapid validator or full-node recovery. Browse the current build at [https://snapshots.posthuman.digital/celestia-testnet/](https://snapshots.posthuman.digital/celestia-testnet/).
